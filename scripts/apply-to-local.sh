...
rsync -a --delete "${ROOT}/shared/references/" "${HOME_DIR}/.agents/references/"
rsync -a --delete "${ROOT}/codex/skills/" "${HOME_DIR}/.agents/skills/"
rsync -a --delete "${ROOT}/codex/agents/" "${HOME_DIR}/.codex/agents/"
rsync -a --delete "${ROOT}/claude/skills/" "${HOME_DIR}/.claude/skills/"
rsync -a --delete "${ROOT}/claude/agents/" "${HOME_DIR}/.claude/agents/"
